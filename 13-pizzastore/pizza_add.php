...
if (!empty($_POST)) {
    ...
    //if(empty($error)){
        ...
        $fileName = 'assets/img/'.$image['name'];
        ...
        //Si l'extentsion n'est pas autorisée, il y a une erreur
        ...
        move_uploaded_file($file,__DIR__.'/'.$fileName); // On déplace le fichier uploadé où on le souhaite
        }
    //}
...
<main class="container">
    ...
    <form method="POST" enctype="multipart/form-data">
        <div class="row">
            ...
            <option for='__'></option>
            <option for="Coté Obscur">Coté Obscur</option>
            <option for="Coté Lumineux">Coté Lumineux</option>
            <option for="Chasseurs de primes">Chasseurs de primes</option>
        </select>
